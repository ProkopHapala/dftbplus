...
- [ ] **NEW A/B backlog (post-2026-09-14):** Jacobi warm-path prologue early-out (V-init + off-reduce skipped when nsw=0, R8b finding) · `PAIR_WG` tuning + p–p register spill (W9b residual) · `e_atom` emission from gather (I10 residual).
