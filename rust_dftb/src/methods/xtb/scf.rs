...
use crate::methods::xtb::coulomb::{
    build_coulomb_matrix, build_coulomb_matrix_gfn2, thirdorder_potential,
    thirdorder_potential_gfn2,
};
use crate::methods::xtb::hamiltonian::{build_h0_s, build_h0_s_gfn2};
use crate::methods::xtb::mulliken::{
    atomic_charges, reference_shell_occupations, reference_shell_occupations_gfn2, shell_charges,
};
...
pub fn compute_multipole_potentials(
    ...
    if nat == 2 {
        eprintln!(
            "DEBUG vat breakdown: vat_sd[0]={:.9e}, vat_sq[0]={:.9e}, vat[0]={:.9e}",
            vat_sd[0], vat_sq[0], vat[0]
        );
    }
...
pub fn run_scf(
    ...
    let nshell_per_atom: Vec<usize> = elem_idx
        ...
        .collect();
    let ang_per_shell: Vec<usize> = elem_idx
        .iter()
        .flat_map(|&z| {
            match z {
                0 => vec![0, 0], // H: s, s
...
pub fn run_scf_gfn2(
    ...
    use crate::methods::xtb::mulliken::{atomic_charges, atomic_multipoles, shell_charges};
    ...
    let (dipole_ints, quadrupole_ints) =
        multipole_integrals::build_multipole_integrals_gfn2(coords, elem_idx);
